            ...
            'colSlideEffect': function(){
                ...
                $(window).scroll(function(){
                    ...
                    $.each($(containerDiv['selector']+'>div'), function(i,v){
                        ...
                        if(isOdd){
                            console.log('ODD:' + currentBottom);
                            $(v).css({
                                'bottom': currentBottom-scrollAmount
                            });
                        }else{
                            console.log('EVEN:' + currentBottom);
                            $(v).css({
                                'bottom': currentBottom+scrollAmount
                            });
                        }
                ...
                'responsiveHide': function(winWidth){
                    ...
                    $.each($(containerDiv['selector']+'>div'), function(i,v){
                        if(config.col[i].responsiveHideLessThan>=winWidth){
                            ...
                            var xOffset=config.col[i].colMaxWidth*activeCols + config.horzMargin*activeCols;
                            $(v).css({
                                'display':'block',
                                'left':xOffset+'px'
                            });
